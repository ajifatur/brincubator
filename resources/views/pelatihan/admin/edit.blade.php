				...
				<div class="row">
						<div class="col-xl-12">
								<div class="breadcrumb-holder">
										<h1 class="main-title float-left">Edit Pelatihan</h1>
					...
					<div class="col-12">						
						<div class="card mb-3">
							<div class="card-header">
								<h3><i class="fa fa-check-square-o"></i> Edit Pelatihan</h3>
							</div>
								
							<div class="card-body">
								
								<form method="post" action="/admin/pelatihan/update">
								  {{ csrf_field() }}
								  <div class="row">
									<div class="col-md-6 mb-3">
									  <label>Nama Pelatihan</label>
									  <input type="text" name="nama" class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}" placeholder="Nama Pelatihan" value="{{ $pelatihan->nama }}">
									  @if($errors->has('nama'))
									...
									<div class="col-md-6 mb-3">
									  ...
									  <input type="text" name="lokasi_pelatihan" class="form-control {{ $errors->has('lokasi_pelatihan') ? 'is-invalid' : '' }}" placeholder="Lokasi Pelatihan" value="{{ $pelatihan->lokasi_pelatihan }}">
									...
									<div class="col-md-3 mb-3">
									  ...
									  <input type="text" name="tanggal_pelatihan" id="tanggal_pelatihan" class="form-control {{ $errors->has('tanggal_pelatihan') ? 'is-invalid' : '' }}" placeholder="Tanggal Pelatihan" value="{{ date('m/d/Y', strtotime($pelatihan->tanggal_pelatihan)) }}">
									...
									<div class="col-md-6 mb-3">
									  ...
									  <select name="wilayah_id" class="form-control {{ $errors->has('wilayah_id') ? 'is-invalid' : '' }}">
								  		...
								  		<option value="{{ $data->id }}" {{ $pelatihan->wilayah_id == $data->id ? 'selected' : '' }}>{{ $data->nama_kota }}</option>
									  	@endforeach
									  </select>
...
<script>
    $(function() {
      ...
      // Plugin wickedpicker...
      $('#jam_pelatihan_mulai').wickedpicker({now: "{{ $pelatihan->jam_pelatihan[0] }}", twentyFour: true});
      $('#jam_pelatihan_selesai').wickedpicker({now: "{{ $pelatihan->jam_pelatihan[1] }}", twentyFour: true});
    });
</script>
