...
!function($) {
    ...
    Sidemenu.prototype.openLeftBar = function() {
      ...
      if($("#main").hasClass("enlarged") && $("body").hasClass("adminbody")) {
        ...
        // $("#logo-full").addClass("d-none").removeClass("d-sm-none").removeClass("d-md-block");
        // $("#logo-mini").addClass("d-block").removeClass("d-sm-block d-md-none");
      } else if(!$("#main").hasClass("enlarged") && $("body").hasClass("adminbody-void")) {
        $("body").removeClass("adminbody-void").addClass("adminbody");
        // $("#logo-full").removeClass("d-none").addClass("d-sm-none d-md-block");
        // $("#logo-mini").removeClass("d-block").addClass("d-sm-block d-md-none");
      }
    ...
    Sidemenu.prototype.init = function() {
      ...
      this.$openLeftBtn.on(event, function(e) {
        ...
        if(w >= 768 && $("body").hasClass("adminbody")){
            $("#logo-full").addClass("d-md-block");
            $("#logo-mini").addClass("d-md-none");
        }
        else if(w >= 768 && $("body").hasClass("adminbody-void")){
